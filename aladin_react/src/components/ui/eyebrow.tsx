 ...
 *
 * There used to be an `.eyebrow` class in index.css with ~34 call sites, and the audit found
 ...
 * easy to not use. A component is what people reach for. The class is now deleted — this is
 * the only eyebrow in the app.
 *
...
export function Eyebrow({
  ...
  as: Tag = "div",
  ...props
}: HTMLAttributes<HTMLElement> & { htmlFor?: string } & {
  tone?: "quiet" | "loud";
  as?: Extract<ElementType, "div" | "span" | "p" | "h2" | "h3" | "h4" | "label">;
}) {
  return (
    <Tag
      className={cn(
