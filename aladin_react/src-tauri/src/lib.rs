...
use crate::commands::{
    ...
    reading_position as reading_position_cmd, shard_kv as shard_kv_cmd, sync as sync_cmd,
    terminal as terminal_cmd, watchlists as watchlist_cmd,
};
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            artifact_cmd::db_query_artifacts_by_property,
            artifact_cmd::db_artifact_property_facets,
            artifact_cmd::db_list_artifact_entities,
            artifact_cmd::db_attach_artifact_entity,
            artifact_cmd::db_detach_artifact_entity,
            artifact_cmd::db_sync_artifact_mentions,
            ...
            shard_kv_cmd::db_list_shard_kv,
            reading_position_cmd::db_get_reading_position,
