...
func (s *Server) handleFeedSave(w http.ResponseWriter, r *http.Request) {
	s.updateArtifactUserStatus(w, r, "saved")
}
func (s *Server) handleFeedDismiss(w http.ResponseWriter, r *http.Request) {
	s.updateArtifactUserStatus(w, r, "dismissed")
}
func (s *Server) handleFeedUnsave(w http.ResponseWriter, r *http.Request) {
	s.updateArtifactUserStatus(w, r, "")
}

func (s *Server) updateArtifactUserStatus(w http.ResponseWriter, r *http.Request, status string) {
	id := r.PathValue("id")
