...
func (c *MCPProcess) Artifacts() artifact.ArtifactService            { return c.artifacts }
...
func (c *MCPProcess) EntityTags() entities.EntityTagService          { return c.entityTags }
func (c *MCPProcess) ArtifactRefs() artifactref.ArtifactRefService   { return c.artifactRefs }
func (c *MCPProcess) EntityContext() entities.EntityContextService   { return c.entityContext }
